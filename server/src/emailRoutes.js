  ...
  try {
    const mockEmails = [
      ...
      },
      {
        ...
        body: 'Several bottles in my latest case (Lot KK-2026-0428) arrived visibly bloated and one had leaked inside the box. The best-before date is June 15. I'm concerned about safety — is this normal for a fermented product or is this a quality issue? Photos attached.',
      ...
      },
      {
        ...
        body: 'My Costco online order arrived with 3 out of 8 bottles shattered. The box was clearly crushed on one side. Lot number on surviving bottles is KK-2026-0501. I'd like a replacement or refund. This was supposed to be a gift.',
        inbox: 'orders@kefirkultures.com',
      },
      {
        id: 'mock-004',
