...
import routes from './routes/quality/dashboard.js';
import complaintRoutes from './routes/quality/complaints.js';
import authRoutes from './routes/admin/auth.js';
import auditRoutes from './routes/shared/audit.js';
import fileRoutes from './routes/documents/files.js';
import simpleDocRoutes from './routes/documents/simpleDocs.js';
import adminRoutes from './routes/admin/admin.js';
import batchTestRoutes from './routes/quality/batchTests.js';
import formRoutes from './routes/quality/forms.js';
import taskboardRoutes from './routes/quality/taskboard.js';
import changeControlRoutes from './routes/quality/changeControls.js';
import maintenanceRoutes from './routes/quality/maintenance.js';
import recallRoutes from './routes/quality/recalls.js';
import sosRoutes from './routes/inventory/sos.js';
import printRoutes from './routes/quality/print.js';
import environmentalRoutes from './routes/quality/environmental.js';
import supplierRoutes from './routes/admin/suppliers.js';
import linkRoutes from './routes/quality/links.js';
import aiRoutes from './routes/shared/ai.js';
import aiChatRoutes from './routes/shared/aiChat.js';
import journalRoutes from './routes/legacy/journal.js';
import emailRoutes from './routes/shared/email.js';
import diagnosticsRoutes from './routes/shared/diagnostics.js';
import plannerRoutes from './routes/legacy/planner.js';
import dailyTaskRoutes from './routes/quality/dailyTasks.js';
import inventoryRoutes from './routes/inventory/stock.js';
import pickListRoutes from './routes/inventory/picks.js';
import itemRoutes from './routes/inventory/items.js';
import lotRoutes from './routes/inventory/lots.js';
...
app.use('/api', requireAuth, lotRoutes);
