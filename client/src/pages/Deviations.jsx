...
const DEV_STATUS_OPTIONS = ['reported', 'under_investigation', 'pending_disposition', 'pending_closure', 'capa_defined', 'closed'];
const DEV_STATUS_STYLES = {
  ...
  pending_disposition: 'bg-purple-100 text-purple-700 border-purple-200',
  pending_closure: 'bg-indigo-100 text-indigo-700 border-indigo-200',
