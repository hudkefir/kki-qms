...
## Project
- **Repo:** kki-qms
- **Stack:** Node.js, Express, PostgreSQL (Cloud SQL), deployed on Google Cloud Run (us-east1)
- **Frontend:** Vanilla JS + HTML templates
- **Database:** Cloud SQL PostgreSQL (kki-db, us-central1)
- **Deploy:** Push to main → GitHub Actions auto-deploys to Cloud Run

## Key Files
- `server/src/routes/shared/ai.js` — Jarvis AI assistant (Claude Sonnet 4.6, 12 tools)
